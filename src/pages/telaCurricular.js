...
const TelaCurricular = ({ navigation }) => { // Alterado para incluir o objeto de navegação
  ...
  return (
    <ImageBackground source={require('../img/fundo.jpeg')} style={styles.backgroundImage}>
      <ScrollView contentContainerStyle={styles.container}>
        <TouchableOpacity style={styles.circulo} onPress={() => navigation.navigate('Turmas')}>
          <Image style={styles.imagemCirculo1} source={require('../img/icone projeto.png')} />
          <Text style={styles.textoCirculo}>Turmas</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.circulo} onPress={() => console.log("Botão 2 pressionado")}>
          <Image style={styles.imagem} source={require('../img/icone gradico.png')} />
        ...
        <TouchableOpacity style={styles.circulo} onPress={() => console.log("Botão 3 pressionado")}>
          <Image style={styles.imagemCirculo3} source={require('../img/icone mt feio.png')} />
